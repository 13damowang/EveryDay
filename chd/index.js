 ...
 * Num=5&Price=1500&ID=1741
 * Num 数量，Price 单价 ID商品id（同样商品会根据日期变化）
 */
let url = "https://chdact.web.sdo.com/project/10yuan_Autumn/BuyItem.asp?0.6792630640908661"
let params = 'BuyType=2'
function ajax (obj) {
